...
const CTA = () => {
    return (
        <div id="cta" className="2xl:py-24 xl:py-20 lg:py-18 xs:py-15 py-10 flex items-center justify-center relative">
            <div className="text-center relative">
                <Reveal>
                    <h1 className="akira  text-lg xs:text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-tertiary-white leading-[1.15]">
                ...
                <motion.img
                    ...
                    className='absolute xl:top-26 xl:right-63 xl:w-30 lg:top-19 lg:right-45 md:top-16 md:w-22 md:right-46 sm:w-20 sm:top-13 sm:right-41 xs:top-11 xs:right-25 xs:w-18 hidden xs:block' src={heroLine1}
                />
                <motion.img
                    variants={fadeIn("left", "spring", 1, 1)}
                    className='absolute xl:top-28 xl:right-68 xl:w-25  lg:top-21 lg:right-50 lg:w-20 md:top-18 md:right-53 md:w-15 sm:w-13 sm:top-14.5 sm:right-47 xs:w-11 xs:top-12.5 xs:right-32 xs:block hidden'  src={heroLine2}/>
                <motion.img
                    variants={fadeIn("right", "spring", 1, 1)}
                    className='absolute xl:left-33 xl:top-43 xl:-rotate-10 xl:w-10 lg:w-9 lg:left-15 lg:top-37 md:w-8 md:left-15 md:top-34 sm:w-7 sm:left-15 sm:top-27 xs:w-7 xs:left-10 xs:top-23 xs:block hidden' src={heroArrow}/>
