...
const Values = () => {
    return (
        <div id="values" className='2xl:py-24 xl:py-20 lg:py-18 xs:py-15 py-10 flex items-center justify-center relative'>
            <div className='flex flex-col gap-20 items-center justify-center w-full'>
                <div className='flex flex-col gap-4 items-center justify-center'>
                    ...
                    <Reveal>
                        <h2 className='akira text-primary-red text-lg xs:text-xl sm:text-xl md:text-3xl lg:text-4xl xl:text-5xl text-center leading-[1.05]'>
